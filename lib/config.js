...
function readConfig() {
	const enableOutboundPgmqWorker =
		process.env.ENABLE_OUTBOUND_PGMQ_WORKER !== "false" &&
		process.env.ENABLE_QUEUE_WORKER !== "false"
	...
	return {
		...
		outboundMaxAttempts: asNumber(process.env.OUTBOUND_MAX_ATTEMPTS, 5),
	}
}
